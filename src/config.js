  ...
  window.GAME_SETTINGS = Object.freeze({
    ...
    audio: {
      ...
      music: {
        ...
        bassWave: "triangle",
        bassVolume: 0.38,
        // NEW BRITAIN（Amazing Grace）の主旋律。1拍の弱起後、3/4拍子で進む。
        lead: [
          ["D4", 1],
          ["G4", 2], ["B4", 0.5], ["G4", 0.5],
          ["B4", 2], ["A4", 1],
          ...
          ["B4", 2], ["B4", 0.5], ["D5", 0.5],
          ["D5", 2], ["B4", 1],
          ["D5", 1.5], ["B4", 0.5], ["D5", 0.5], ["B4", 0.5],
          ["G4", 2], ["D4", 1],
          ["E4", 1.5], ["G4", 0.5], ["G4", 0.5], ["E4", 0.5],
          ["D4", 2], ["D4", 1],
          ["G4", 2], ["B4", 0.5], ["G4", 0.5],
          ["B4", 2], ["A4", 1],
          ["G4", 3]
        ],
        // 1小節3拍。矩形波アルペジオと三角波ベースを重ねてFC風にする。
        chords: [
